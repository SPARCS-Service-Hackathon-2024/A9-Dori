...
import com.example.demo.deprecated.handler.LoginFailureHandler;
...
import static com.example.demo.utils.constant.UriConstant.*;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(
                                new AntPathRequestMatcher(LOGIN_URI),
                        ...
                        .hasAnyAuthority(AUTH_UNVERIFIED, AUTH_VERIFIED)
                        .requestMatchers(
                                new AntPathRequestMatcher(VERIFY_URI),
